...
First Pass: Go down the column to add up all the numbers and calculate the average .
...
Divide that total by the number of rows minus 1 and use std::sqrt() to get the final answer.
